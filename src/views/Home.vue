            ...
            <div class="col-xs-12">
                ...
                <form @submit.prevent="isSubmitted= true" >
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="content" v-model.lazy="post.content" cols="30" rows="10"></textarea>
                    </div>

                    <div class="form-group">
                        <input type="checkbox" v-model="post.publishImmediately" id="publish-immediately" >
                    ...
                    <div class="form-group">
                        <select class="form-control" id="select-series" v-model="post.series">
                            ...
                            <option v-for="series in formData.series" :key="series" :value="series">{{ series }}</option>
                        </select>
                    </div>
                ...
                <table class="table table-striped" v-if="isSubmitted">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li v-for="post in post.shareOn" :key="post">{{post}}</li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
